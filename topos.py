...
class GraphTopo(Topo):
    ...
    def __init__(self, G, H):
        ...
        for u, v in G.edges:
            if u in H:
                self.addLink(hosts[u], switches[v], delay='10ms', max_queue_size = 10)
            elif v in H:
                self.addLink(switches[u], hosts[v], delay='10ms', max_queue_size = 10)
            else:
                self.addLink(switches[u], switches[v], delay='10ms', max_queue_size = 10)
